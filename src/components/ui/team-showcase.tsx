...
export default function TeamShowcase({ members = DEFAULT_MEMBERS }: TeamShowcaseProps) {
  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-center lg:items-start gap-8 md:gap-10 lg:gap-14 select-none w-full max-w-5xl mx-auto py-8 px-4 md:px-6 font-sans">
      {/* ── Left: photo grid ── */}
      <div className="flex gap-2 md:gap-3 flex-shrink-0 overflow-x-auto pb-1 md:pb-0 justify-center">
        {/* Column 1 */}
        ...
        {/* Column 3 - Only show if there are members in this column */}
        {col3.length > 0 && (
      ...
      <div className="flex items-center gap-2.5">
        <span
          className={cn(
            ...
            isActive ? 'bg-brand-navy w-5' : 'bg-brand-navy/25',
          )}
        />
        <span
          className={cn(
          ...
          >
            {member.social?.twitter && (
              <a
                ...
                className="p-1 rounded text-brand-navy hover:text-brand-saffron hover:bg-brand-saffron/10 transition-all duration-150 hover:scale-110"
                title="X / Twitter"
              >
                <FaTwitter size={10} />
              </a>
